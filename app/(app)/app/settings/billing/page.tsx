...
import { CreditCard, Download, AlertTriangle, Sparkles } from "lucide-react";
        ...
        <div className="mb-3 flex items-start justify-between">
          <div>
            ...
            <div className="mt-1 flex items-baseline gap-2">
              <div className="text-2xl font-extrabold text-ink">{BILLING.plan}</div>
              <StatusPill tone="green">{BILLING.billingCycle}</StatusPill>
            </div>
            <div className="mt-1 text-[12px] text-ink-muted">Renews {BILLING.nextRenewal} · ${BILLING.amountDue.toLocaleString()} / year</div>
          </div>
          <div className="flex gap-2">
            ...
            <button className="rounded-xl bg-grad-cta px-4 py-2 text-[13px] font-bold text-white shadow-violet">Upgrade</button>
          </div>
        </div>
