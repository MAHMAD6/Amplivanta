...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/app/marketing-automation/landing-page-templates", destination: "/app/marketing/landing-page-templates", permanent: false },
      { source: "/app/marketing-automation/landing-page-analytics", destination: "/app/marketing/landing-page-analytics", permanent: false },
