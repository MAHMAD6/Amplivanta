  ...
  return (
    <section className="px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <ScrollReveal>
          <div className="grid gap-8 rounded-3xl bg-[#1A3C2B] p-8 md:grid-cols-2 md:p-12">
            <div className="rounded-2xl border border-[#2A4A38] p-8">
              <span className="font-mono text-2xl font-bold text-[#B5FF2D]">01</span>
            ...
            <div className="rounded-2xl border border-[#2A4A38] p-8">
              <span className="font-mono text-2xl font-bold text-[#B5FF2D]">02</span>
