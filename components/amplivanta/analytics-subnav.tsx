...
const TABS = [
  ...
  { label: "Traffic", href: "/app/analytics/traffic" },
  { label: "Campaigns", href: "/app/analytics/campaigns" },
  { label: "Funnel", href: "/app/analytics/funnel" },
  { label: "Attribution", href: "/app/analytics/attribution" },
  { label: "Report Builder", href: "/app/analytics/report-builder" },
];
