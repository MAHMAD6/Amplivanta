...
const MOCK_WORKSPACES = [
  { id: "1", name: "Amplivanta Workspace", plan: "Growth" },
  { id: "2", name: "BrightTech Inc.", plan: "Scale" },
  { id: "3", name: "NextGen Solutions", plan: "Starter" },
];
    ...
    <aside className="fixed inset-y-0 left-0 z-30 flex w-[248px] flex-col border-r border-navy-border bg-[#0d0b18] text-white">
      ...
      <div className="relative px-3 pb-3">
        ...
        >
          <div className="min-w-0">
            <div className="truncate text-[12.5px] font-semibold">{activeWs.name}</div>
            <div className="text-[10px] text-white/50">{activeWs.plan} plan</div>
          </div>
      ...
      <div className="mx-3 mb-3 rounded-xl border border-white/10 bg-white/5 p-3">
        ...
        <div className="mt-1 flex items-baseline gap-1">
          <span className="text-lg font-extrabold text-white">2,450</span>
          <span className="text-[11px] text-white/50">/ 5,000</span>
        </div>
        <div className="mt-1.5 h-1.5 overflow-hidden rounded-full bg-white/10">
          <div className="h-full w-[49%] rounded-full bg-grad-brand" />
        </div>
        <div className="mt-1.5 text-[10px] text-white/50">Resets on Jun 1, 2026</div>
